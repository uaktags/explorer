...
module.exports = {
    get_data: function (settings, cb) {
        var error = null;
        get_orders(settings.coin, settings.exchange, settings.coinexchange_id, function (err, buys, sells) {
            if (err) { error = err; }
            get_trades(settings.coin, settings.exchange, settings.coinexchange_id, function (err, trades) {
                if (err) { error = err; }
                get_summary(settings.coin, settings.exchange, settings.coinexchange_id, function (err, stats) {
                    if (err) { error = err; }
